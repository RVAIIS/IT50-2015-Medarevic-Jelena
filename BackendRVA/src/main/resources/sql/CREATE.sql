...
DROP SEQUENCE IF EXISTS smjer_seq CASCADE;
DROP SEQUENCE IF EXISTS grupa_seq CASCADE; 
DROP SEQUENCE IF EXISTS student_seq CASCADE;
DROP SEQUENCE IF EXISTS projekat_seq CASCADE;
...
ALTER TABLE grupa ADD CONSTRAINT FK_Grupa_Smjer
	FOREIGN KEY (smjer) REFERENCES smjer (id) ON DELETE CASCADE ;
ALTER TABLE student ADD CONSTRAINT FK_Student_Grupa
	FOREIGN KEY (grupa) REFERENCES grupa (id) ON DELETE CASCADE ;
ALTER TABLE student ADD CONSTRAINT FK_Student_Projekat
	FOREIGN KEY (projekat) REFERENCES projekat (id) ON DELETE CASCADE ;
